...
#
proc ::ngBot::plugin::PreTime::init {args} {
  variable np
...
#
proc ::ngBot::plugin::PreTime::deinit {args} {
  variable np
  variable mysql
  variable scriptName
  variable ${np}::precommand
...
proc ::ngBot::plugin::PreTime::Debug {msg} {
  putlog "\[ngBot\] PreTime :: $msg"
}

proc ::ngBot::plugin::PreTime::Error {error} {
...
# found and 0 if not.
#
proc ::ngBot::plugin::PreTime::LookUp {release timeVar} {
...
#
proc ::ngBot::plugin::PreTime::LogEvent {event section logData} {
  variable np
  variable ns
  variable lateMins
  variable ignoreDirs
