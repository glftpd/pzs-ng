...
#
proc ::ngBot::plugin::AutoIRCFlag::init {args} {
...
#
proc ::ngBot::plugin::AutoIRCFlag::deinit {args} {
...
#
proc ::ngBot::plugin::AutoIRCFlag::GetInfo {ftpUser groupVar flagsVar} {
  variable np
...
#
proc ::ngBot::plugin::AutoIRCFlag::GiveIRCFlag {nick host handle channel} {
  variable ns
  variable np
  variable perms
