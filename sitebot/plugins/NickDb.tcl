...
#
proc ::ngBot::plugin::NickDb::deinit {args} {
  variable np
  variable ${np}::postcommand
  variable scriptName
...
#
proc ::ngBot::plugin::NickDb::StripName {name} {
...
#
proc ::ngBot::plugin::NickDb::InviteEvent {event ircUser ftpUser ftpGroup ftpFlags} {
  variable np
  variable hostChange
  variable hostExempt
  variable hostFormat
...
#
proc ::ngBot::plugin::NickDb::NickChange {nick host handle channel newNick} {
...
#
proc ::ngBot::plugin::NickDb::GetIrcUser {ftpUser} {
...
# no matches are found, an empty string is returned.
#
proc ::ngBot::plugin::NickDb::GetFtpUser {ircUser} {
