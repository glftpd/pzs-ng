...
proc ::ngBot::plugin::TVMaze::deinit {args} {
  variable ns
  variable np
  variable ${np}::postcommand
...
proc ::ngBot::plugin::TVMaze::Debug {msg} {
  putlog "\[ngBot\] TVMaze :: $msg"
}

proc ::ngBot::plugin::TVMaze::Error {error} {
  putlog "\[ngBot\] TVMaze Error :: $error"
}

proc ::ngBot::plugin::TVMaze::ConvertDate {string} {
  variable tvmaze
...
proc ::ngBot::plugin::TVMaze::Trigger {args} {
  variable ns
  variable np
  variable tvmaze
...
proc ::ngBot::plugin::TVMaze::LogEvent {event section logData} {
  variable ns
  variable np
  variable tvmaze
...
proc ::ngBot::plugin::TVMaze::FindInfo {string logData {strict true}} {
  variable ns
...
proc ::ngBot::plugin::TVMaze::GetShowAndEpisode {show season epnumber} {
  variable tvmaze
...
proc ::ngBot::plugin::TVMaze::GetFromApi {uri query} {
  variable tvmaze
