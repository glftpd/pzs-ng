...
proc ::ngBot::plugin::TVRage::deinit {args} {
  variable ns
  variable np
  variable ${np}::postcommand
...
proc ::ngBot::plugin::TVRage::Debug {msg} {
  putlog "\[ngBot\] TVRage :: $msg"
}

proc ::ngBot::plugin::TVRage::Error {error} {
  putlog "\[ngBot\] TVRage Error :: $error"
}

proc ::ngBot::plugin::TVRage::ConvertDate {string} {
  variable tvrage
...
proc ::ngBot::plugin::TVRage::Trigger {args} {
  variable ns
  variable np
  variable tvrage
...
proc ::ngBot::plugin::TVRage::LogEvent {event section logData} {
  variable ns
  variable np
  variable tvrage
...
proc ::ngBot::plugin::TVRage::FindInfo {string logData {strict true}} {
  variable ns
...
proc ::ngBot::plugin::TVRage::GetShowAndEpisode {show season epnumber} {
  variable ns
  variable tvrage
