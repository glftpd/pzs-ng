...
#
proc ::ngBot::plugin::Blow::Debug {msg} {
  variable np
...
# Pretty self-explanatory
#
proc ::ngBot::plugin::Blow::Error {error} {
...
#
proc ::ngBot::plugin::Blow::SetTopic {channel topic} {
  variable ns
...
#
proc ::ngBot::plugin::Blow::GetTopic {channel} {
  variable ns
...
#
proc ::ngBot::plugin::Blow::breakLine {line lineArr} {
  variable ns
  variable maxLength
  variable splitChar
...
#
proc ::ngBot::plugin::Blow::isMsgEncrypted {} {
...
#
proc ::ngBot::plugin::Blow::reEscape {str} {
  regsub -all {\W} $str {\\&}
}
...
#
proc ::ngBot::plugin::Blow::getKey {target} {
  variable keyx
  variable blowkey
  variable mainChan
...
#
proc ::ngBot::plugin::Blow::matchChan {target} {
  variable blowkey
...
#
proc ::ngBot::plugin::Blow::encryptThis {text} {
...
proc ::ngBot::plugin::Blow::is_trustedusers {} {
  variable trustedUsers
...
proc ::ngBot::plugin::Blow::is_topicusers {} {
  variable topicUsers
...
#
proc ::ngBot::plugin::Blow::keyx_nick {nick host hand chan newnick} {
  variable blowkey
  variable keyxinit
  variable keyxtimer
  variable keyxqueue
...
proc ::ngBot::plugin::Blow::keyx_generate {target name_public {name_private ""}} {
  variable blowso
  variable blowinit
  variable fishpy
  variable keyxCbc
...
proc ::ngBot::plugin::Blow::keyx_init {target} {
  variable ns
  variable np
...
proc ::ngBot::plugin::Blow::keyx_bind {nick host handle text dest} {
  variable np
  variable ns
  variable keyx
  variable keyxUsers
...
proc ::ngBot::plugin::Blow::keyx_queue {target type command text {option ""}} {
  variable ns
  variable keyxtimer
  variable keyxqueue
...
proc ::ngBot::plugin::Blow::keyx_queue_delete {target} {
  variable keyxqueue
  variable keyxtimer
...
proc ::ngBot::plugin::Blow::keyx_queue_flush {target} {
  variable ns
  variable blowkey
  variable keyxqueue
...
proc ::ngBot::plugin::Blow::IrcTopic {nick host handle channel text} {
  variable ns
  variable np
  variable topicUsers
...
#
proc ::ngBot::plugin::Blow::encryptedIncomingHandler {nick uhost handle args} {
  variable ns
  variable keyx
  variable blowkey
  variable blowinit
...
#
proc ::ngBot::plugin::Blow::unencryptedIncomingHandler {from keyword text} {
  variable ns
  variable np
  variable keyx
  variable trustedUsers
...
#
proc ::ngBot::plugin::Blow::GetInfo {ftpUser groupVar flagsVar} {
  variable ns
  variable np
...
# Outgoing messages
proc ::ngBot::plugin::Blow::put_bind {type text {option ""}} {
  variable ns
  variable keyx
  variable blowinit
  variable maxLength
...
proc ::ngBot::plugin::Blow::put_unencrypted {type text {option ""}} {
  if {$option == ""} {
    put${type}2 $text
  } else {
...
proc ::ngBot::plugin::Blow::put_encrypted {target type command text key {option ""}} {
  variable ns
...
#
proc ::ngBot::plugin::Blow::LogEvent {event section logData} {
  variable ns
...
#
proc ::ngBot::plugin::Blow::init {args} {
  variable ns
  variable np
  variable keyx
  variable blowso
...
#
proc ::ngBot::plugin::Blow::deinit {args} {
  variable ns
  variable np
  variable events
  variable keyxtimer
