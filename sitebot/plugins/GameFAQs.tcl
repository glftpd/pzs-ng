...
proc ::ngBot::plugin::GameFAQs::init {args} {
  variable ns
  variable np
...
proc ::ngBot::plugin::GameFAQs::deinit {args} {
  variable ns
  variable np
  variable ${np}::postcommand
...
proc ::ngBot::plugin::GameFAQs::Debug {msg} {
  putlog "\[ngBot\] GameFAQs :: $msg"
}

proc ::ngBot::plugin::GameFAQs::Error {error} {
  putlog "\[ngBot\] GameFAQs :: Error: $error"
}

proc ::ngBot::plugin::GameFAQs::ConvertDate {string} {
  variable gamefaqs
...
proc ::ngBot::plugin::GameFAQs::Trigger {args} {
  variable ns
  variable np
  variable gamefaqs
...
proc ::ngBot::plugin::GameFAQs::LogEvent {event section logData} {
  variable ns
  variable np
  variable gamefaqs
...
proc ::ngBot::plugin::GameFAQs::FindInfo {string platform logData} {
  variable ns
...
proc ::ngBot::plugin::GameFAQs::FindGame {string platform} {
  variable gamefaqs
...
proc ::ngBot::plugin::GameFAQs::GetGame {url {loop 0}} {
  variable ns
  variable gamefaqs
...
proc ::ngBot::plugin::GameFAQs::GetRating {url} {
  variable gamefaqs
...
proc ::ngBot::plugin::GameFAQs::ToTitle {text} {
  set result [list]
...
proc ::ngBot::plugin::GameFAQs::Cleanup {string} {
...
proc ::ngBot::plugin::GameFAQs::CompareESRB {rating1 rating2} {
  set flag 1
...
proc ::ngBot::plugin::GameFAQs::SelectPlatform {string} {
  array set platforms {
