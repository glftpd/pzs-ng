...
proc ::ngBot::init_version {} {}

proc ::ngBot::init_binaries {} {
	variable ns
	variable bnc
	variable binary
	variable dzerror
...
proc ::ngBot::eventcheck {section event} {
	variable ns
...
proc ::ngBot::eventhandler {type event argv} {
	variable ns
	variable $type
...
proc ::ngBot::parselogin {line eventvar datavar} {
...
proc ::ngBot::parsesysop {line eventvar datavar} {
...
proc ::ngBot::ng_random {event rndvar} {
	variable random
...
proc ::ngBot::ng_format {event section line} {
	variable ns
	variable theme
	variable mpath
	variable random
...
proc ::ngBot::format_duration {secs} {
	set duration ""
...
proc ::ngBot::format_speed {value section} {
	variable ns
	variable theme
...
proc ::ngBot::format_clock {type ctime} {
...
proc ::ngBot::replacebasic {message section} {
	variable cmdpre
	variable sitename
	set pre $cmdpre
...
proc ::ngBot::replacepath {message basepath path} {
	variable ns
...
proc ::ngBot::replacevar {string cookie value} {
	variable zeroconvert
...
proc ::ngBot::trimtail {strsrc strrm} {
...
proc ::ngBot::sndall {event section text} {
	variable ns
	variable chanlist
	variable redirect
...
proc ::ngBot::sndone {chan text {section "none"}} {
	variable ns
	variable splitter
	variable disable
...
proc ::ngBot::checkchan {nick chan} {
	variable disable
	variable mainchan
...
proc ::ngBot::announcetochancheck {bind default} {
	variable bindnopre
	variable cmdpre
...
proc ::ngBot::getoptions {argv p_results p_other} {
...
proc ::ngBot::getsectionname {checkpath} {
	variable mpath
	variable paths
	variable sections
	variable defaultsection
...
proc ::ngBot::getsectionpath {getsection} {
	variable paths
	variable sections
	foreach section $sections {
		if {![info exists paths($section)]} {
...
# STATUS: OK
proc ::ngBot::cmd_preview {handle idx text} {
	variable ns
	variable announce
	variable defaultsection
...
proc ::ngBot::cmd_welcome {nick uhost hand chan} {
	variable ns
	variable disable
	variable announce
	variable chanlist
...
proc ::ngBot::cmd_bnc {nick uhost hand chan arg} {
	variable ns
	variable bnc
	variable theme
	variable binary
...
proc ::ngBot::cmd_help {nick uhost hand chan arg} {
	variable ns
	variable sections
	variable scriptpath
...
proc ::ngBot::cmd_free {nick uhost hand chan arg} {
	variable ns
	variable theme
	variable device
	variable binary
...
proc ::ngBot::cmd_incompletes {nick uhost hand chan arg} {
	variable ns
	variable binary
	variable announcetochan
...
proc ::ngBot::cmd_uptime {nick uhost hand chan argv} {
	variable ns
	variable theme
	variable binary
	variable announce
...
proc ::ngBot::loadtheme {file {isplugin false}} {
	variable ns
	variable theme
	variable random
	variable announce
...
proc ::ngBot::themereplace {targetString section} {
	variable theme
...
proc ::ngBot::themereplace_startup {rstring} {
