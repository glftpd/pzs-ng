...
proc ::ngBot::module::glftpd::::ngBot::module::glftpd::init {} {
  variable np
  variable renames
...
proc ::ngBot::module::glftpd::init_binaries {} {
  variable np
  variable ${np}::dzerror
...
proc ::ngBot::module::glftpd::init_version {} {
  variable np
  variable glversion
  variable ${np}::binary
...
proc ::ngBot::module::glftpd::init_invite {} {
  variable ns
  variable np
...
proc ::ngBot::module::glftpd::readlog {} {
  variable np
  variable ns
  variable glversion
...
proc ::ngBot::module::glftpd::fuelnuke {type path section line} {
  variable ns
  variable np
  variable ${np}::nuke
...
proc ::ngBot::module::glftpd::launchnuke {} {
  variable np
  variable ${np}::nuke
  variable ${np}::mpath
  variable ${np}::theme
...
proc ::ngBot::module::glftpd::launchnuke2 {type path section info nukees} {
  variable np
  variable ${np}::nuke
  variable ${np}::theme
  variable ${np}::mpath
...
proc ::ngBot::module::glftpd::gluserids {} {
  variable np
  variable ${np}::location
  set userlist {}
...
proc ::ngBot::module::glftpd::glgroupids {} {
  variable np
  variable ${np}::location
  set grouplist {}
...
proc ::ngBot::module::glftpd::cmd_stats {type time nick uhost hand chan argv} {
  variable np
  variable ${np}::binary
...
proc ::ngBot::module::glftpd::cmd_new {nick uhost hand chan argv} {
  variable ns
  variable np
  variable ${np}::theme
  variable ${np}::binary
...
proc ::ngBot::module::glftpd::cmd_silo {type nick uhost hand chan argv} {
  variable np
  variable ${np}::theme
  variable ${np}::binary
  variable ${np}::announce
...
proc ::ngBot::module::glftpd::cmd_search {nick uhost hand chan argv} {
  variable ns
  variable np
  variable ${np}::theme
  variable ${np}::binary
...
proc ::ngBot::module::glftpd::cmd_bw {type nick uhost hand chan argv} {
  variable np
  variable ${np}::speed
  variable ${np}::theme
  variable ${np}::binary
...
proc ::ngBot::module::glftpd::cmd_idlers {nick uhost hand chan argv} {
  variable np
  variable ${np}::speed
  variable ${np}::theme
  variable ${np}::binary
...
proc ::ngBot::module::glftpd::cmd_speed {nick uhost hand chan argv} {
  variable np
  variable ${np}::theme
  variable ${np}::binary
  variable ${np}::disable
...
proc ::ngBot::module::glftpd::cmd_transfers {type nick uhost hand chan argv} {
  variable np
  variable ${np}::speed
  variable ${np}::theme
  variable ${np}::binary
...
proc ::ngBot::module::glftpd::cmd_who {nick uhost hand chan argv} {
  variable np
  variable ${np}::binary
  variable ${np}::announcetochan
...
proc ::ngBot::module::glftpd::flagcheck {currentflags needflags} {
...
proc ::ngBot::module::glftpd::rightscheck {rights user group flags} {
  variable ns
  variable np
  variable ${np}::location
...
proc ::ngBot::module::glftpd::inviteuser {nick user group flags} {
  variable np
  variable ns
  variable ${np}::privchannel
...
proc ::ngBot::module::glftpd::invitechan {nick chan} {
...
proc ::ngBot::module::glftpd::cmd_invite {nick host hand argv} {
  variable ns
  variable np
  variable ${np}::theme
  variable ${np}::binary
